...
public class MailGunMessage : IMailGunMessage
{
    ...
    private RecipientData GetMultipartFormDataContent(IEmailRecipient emailRecipient, bool substitute = false)
    {
        ...
        {
            text = Substitute(Text, "text", substitute ? substitutions : null, ref content);
            html = Substitute(Html, "html", substitute ? substitutions : null, ref content);
            ampHtml = Substitute(AmpHtml, "amp-html", substitute ? substitutions : null, ref content);
        }
